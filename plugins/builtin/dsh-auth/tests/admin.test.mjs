...
const script = join(root, 'plugins/builtin/dsh-auth/scripts/auth-admin.mjs')
...
async function fixture(t) {
  ...
  await cp(join(root, 'plugins/builtin/dsh-auth/dist'), join(plugin, 'dist'), { recursive: true })
  await cp(join(root, 'plugins/builtin/dsh-auth/package.json'), join(plugin, 'package.json'))
