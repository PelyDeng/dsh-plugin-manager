...
这是框架 0.18.0 随包指南。模型不可用时仍可在已授权应用中阅读；内容来自发布时固定的公共文档，不扫描部署者机器。在线 main 可能领先，知识不能证明生产状态。
...
- [固定版本作者指南](https://github.com/PelyDeng/dsh-plugin-manager/blob/v0.18.0/doc/plugin-development.md)
- [固定版本部署指南](https://github.com/PelyDeng/dsh-plugin-manager/blob/v0.18.0/doc/first-deployment.md)
- [可复制开发提示词](prompts.md)
