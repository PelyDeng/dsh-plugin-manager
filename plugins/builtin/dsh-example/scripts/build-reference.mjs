...
const directories = ['packages/plugin-manager', 'packages/plugin-kit', 'plugins/builtin/dsh-auth', 'plugins/builtin/dsh-example', 'scripts', 'deploy', 'integrations', 'examples', 'doc', '.github'];
