...
公开文档从[文档导航](doc/README.md)进入作者、部署、配置参考。能力变化需同步 example 随包 knowledge 的 FAQ/提示词；它们就是助手读取的知识，不另维护一份答案。校验来源、命令、知识大小及实际模型输入；真实模型问答与替身测试分别说明。`doc/` 仅保存当前产品的使用、开发、配置、部署、故障排查和版本资料。
